...
def winning(score: str):
    ...
    def quit_without_save():
        pygame.quit()
        sys.exit()
    charachters.menus(score, WINDOW, font_handler.SPACE_INVADERS_FONT, text_colour= WHITE, button1_colour=DARK_BLUE, button2_colour=DARK_BLUE).create_menu(quit_with_save, quit_without_save, main_text="Game Over", win_or_loss="You Won!", button_text1="Quit With Saving", button_text2="Quit Without Saving")
